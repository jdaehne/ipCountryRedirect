...
$packageNameLower = 'ipcountryredirect'; /* No spaces, no dashes */
...
$components = array(
    ...
    'packageDocumentationUrl' => 'https://www.quadro-system.de/modx-extras/ip-country-redirect/',
    'copyright' => '2018',
    ...
    'gitHubRepository' => 'ipCountryRedirect',
    ...
    'newSystemSettings' => array(
        'ipcountryredirect_system_setting1' => array( // key
            'key' => 'ipcr.apikey',
            'name' => 'API-Key',
    ...
    */
    ...
    'namespaces' => array(
        'ipcountryredirect' => array(
            'name' => 'ipcountryredirect',
            'path' => '{core_path}components/ipcountryredirect/',
            'assets_path' => '{assets_path}components/ipcountryredirect/',
        ),
    ...
    */
    ...
    'contexts' => array(
        'ipcountryredirect' => array(
            'key' => 'ipcountryredirect',
            'description' => 'ipcountryredirect context',
            'rank' => 2,
        )
    ),
    */
    ...
    'menus' => array(
        'ipcountryredirect' => array(
            ...
            'action' => array(
                ...
                'controller' => 'index',
                'haslayout' => true,
                'lang_topics' => 'ipcountryredirect:default',
                'assets' => '',
            ),
        ),
    ),
    ...
    */
    ...
    'elements' => array(
        'snippets' => array(
            'ipCountryRedirect' => array(
                'category' => 'ipcountryredirect',
                'description' => 'IP based Country Redirector',
                'static' => true,
            ),
    ...
    */
    ...
    'classes' => array(
        'AnotherClass' => 'ipcountryredirect:ipcountryredirect',
    ...
    */
    ...
    'cmpTemplates' => array (
         'mgr:<div id="ipcountryredirect-panel-home-div"></div>',
    ),
